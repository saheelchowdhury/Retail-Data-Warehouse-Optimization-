...
CREATE TABLE Employees (
	...
	(
		ReportsTo
	) REFERENCES retail_analysis.Employees (
		EmployeeID
	)
);

 CREATE  INDEX LastName ON retail_analysis.Employees(LastName);

 CREATE  INDEX PostalCode ON retail_analysis.Employees(PostalCode);
...
CREATE TABLE Categories (
 ...
 CREATE  INDEX CategoryName ON retail_analysis.Categories(CategoryName);
...
CREATE TABLE Customers (
 ...
 CREATE  INDEX City ON retail_analysis.Customers(City);

 CREATE  INDEX CompanyName ON retail_analysis.Customers(CompanyName);

 CREATE  INDEX PostalCode ON retail_analysis.Customers(PostalCode);

 CREATE  INDEX Region ON retail_analysis.Customers(Region);
...
CREATE TABLE Suppliers (
 ...
 CREATE  INDEX CompanyName ON retail_analysis.Suppliers(CompanyName);

 CREATE  INDEX PostalCode ON retail_analysis.Suppliers(PostalCode);
...
CREATE TABLE Orders (
	...
	(
		CustomerID
	) REFERENCES retail_analysis.Customers (
		CustomerID
	),
	...
	(
		ShipVia
	) REFERENCES retail_analysis.Shippers (
		ShipperID
	)
);

 CREATE  INDEX CustomerID ON retail_analysis.Orders(CustomerID);

 CREATE  INDEX CustomersOrders1 ON retail_analysis.Orders(OrderID);

 CREATE  INDEX EmployeeID ON retail_analysis.Orders(EmployeeID);

  CREATE  INDEX OrderDate ON retail_analysis.Orders(OrderDate);

 CREATE  INDEX ShippedDate ON retail_analysis.Orders(ShippedDate);

 CREATE  INDEX ShippersOrders ON retail_analysis.Orders(ShipVia);

 CREATE  INDEX ShipPostalCode ON retail_analysis.Orders(ShipPostalCode);
...
CREATE TABLE Products (
	...
	(
		CategoryID
	) REFERENCES retail_analysis.Categories (
		CategoryID
	),
	CONSTRAINT FK_Products_Suppliers FOREIGN KEY 
	(
		SupplierID
	) REFERENCES retail_analysis.Suppliers (
		SupplierID
	)
	
);

 CREATE  INDEX CategoriesProducts1 ON retail_analysis.Products(ProductID);

 CREATE  INDEX CategoryID ON retail_analysis.Products(CategoryID);

 CREATE  INDEX ProductName ON retail_analysis.Products(ProductName);

 CREATE  INDEX SupplierID ON retail_analysis.Products(SupplierID);
...
CREATE TABLE Order_Details (
	...
	(
		OrderID
	) REFERENCES retail_analysis.Orders (
		OrderID
	),
	CONSTRAINT FK_Order_Details_Products FOREIGN KEY 
	(
		ProductID
	) REFERENCES retail_analysis.Products (
		ProductID
	)
	
);

 CREATE  INDEX OrderID ON retail_analysis.Order_Details(OrderID);



 CREATE  INDEX ProductID ON retail_analysis.Order_Details(ProductID);
...
CREATE TABLE retail_analysis.Region 
	( RegionID int NOT NULL ,
	RegionDescription char (50) NOT NULL 
) ;


CREATE TABLE retail_analysis.Territories 
...
CREATE TABLE retail_analysis.EmployeeTerritories 
...
ALTER TABLE Territories
	...
	(
		RegionID
	) REFERENCES retail_analysis.Region (
		RegionID
	);
...
ALTER TABLE EmployeeTerritories	
	...
	(
		TerritoryID
	) REFERENCES retail_analysis.Territories (
		TerritoryID
	);
